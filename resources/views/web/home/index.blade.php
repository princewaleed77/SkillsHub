			...
			<div class="container">
				...
				<div class="row">
					<div class="center-btn">
						<a class="main-button icon-button" href="#">@lang('web.morecoursesbtn')</a>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-8 col-md-offset-2 text-center">
						...
						<a class="main-button icon-button" href="contact.html">{{__('web.contactusnowbtn')}}</a>
					</div>
